...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% Main program
g_list = linspace(g2, g2 + delta_max, g_num);
GAMMA_TABLE = [];
GAMMA_TABLE = gamma_iterate(g1, g2, n, g_list, GAMMA_TABLE, ...
    alpha, d_max, d_accuracy, error, delta_max);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %

% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% Save file
filename = 'alpha_phase_sync_low_g';
folder = 'plots_data_181223';
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% Finctions
function GAMMA_TABLE = gamma_iterate(g1, g2, n, g_list, ...
    GAMMA_TABLE, alpha, d_max, d_accuracy, error, delta)
...
function draw(T, Y, g, d)
    ...
    title(sprintf('d = %g, Δ_1 = %g, Δ_2 = %g, α = %s', d, delta_1, delta_2, alpha_text));
